...
hi Comment      term=bold      cterm=bold ctermfg=8             gui=none      guifg=#c0c0c0
...
hi StatusLine   term=none      cterm=bold ctermfg=8  ctermbg=7  gui=none      guifg=#0f2f2f guibg=#8fbc8f
